...
const ImageSequence = forwardRef(({ progress }, ref) => {
  ...
  const data =[
    ...
    [{tag : "h1", text : "Legend"}],
    [{tag : "h1", text : "Legend"}],
    [{tag : "h1", text : "Legend"},{tag : "h1", text : "TRUGLOW"}],
    [{tag : "h1", text : "Legend"},{tag : "h1", text : "TRUGLOW"}],
    [{tag : "h1", text : "Legend"},{tag : "h1", text : "TRUGLOW"}],
    [{tag : "h1", text : "Legend"},{tag : "h1", text : "TRUGLOW"}],
    [{tag : "h1", text : "Legend"},{tag : "h1", text : "TRUGLOW"}],
    [{tag : "h1", text : "Legend"},{tag : "h1", text : "TRUGLOW"}],
    [{tag : "h1", text : "Legend"},{tag : "h1", text : "TRUGLOW"}],
    [{tag : "h1", text : "Legend"},{tag : "h1", text : "TRUGLOW"},{tag : "h1", text : "FS-1"}],
    [{tag : "h1", text : "Legend"},{tag : "h1", text : "TRUGLOW"},{tag : "h1", text : "FS-1"}],
    [{tag : "h1", text : "Legend"},{tag : "h1", text : "TRUGLOW"},{tag : "h1", text : "FS-1"}],
    [{tag : "h1", text : "Legend"},{tag : "h1", text : "TRUGLOW"},{tag : "h1", text : "FS-1"}],
    [{tag : "h1", text : "Legend"},{tag : "h1", text : "TRUGLOW"},{tag : "h1", text : "FS-1"}],
  ...
  function createData(data){
    return(
      <>
        {data.map(elem => {
          if(elem.tag === "h1") return <h1 className="heading">{elem.text} <br/> </h1>
          if(elem.tag === "p") return <p className="content">{elem.text} <br/></p>
        })}
      </>
    )
